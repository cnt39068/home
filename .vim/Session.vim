...
nmap ,ih :IHS
nmap ,fe :Sexplore!
nmap ,o :so ~/.vim/Session.vim
nmap ,m :mks! ~/.vim/Session.vim
nmap ,t :!aspell check %:e! %
nmap ,gs :call LoadSsmTags()
nmap ,gp :call LoadSpmTags()
nmap ,fu :se ff=unix
nmap ,fd :se ff=dos
map ,e :e ~/.vimrc
map ,s :source ~/.vimrc
...
nmap ,p "+p
nmap ,y "+y
nmap ,l :let g:LookupFile_TagExpr = '"/localdisk/data/src/tags/filenametags"'
nmap ,r :cs add /localdisk/data/src/tags/cscope.out
nmap ,c :close
nmap ,f :find
nmap ,w :w!
imap ´ <End>
...
nmap <C-F12> :!~/tool/ctags57/bin/ctags -R --exclude=lost+found --c++-kinds=+p --fields=+iaS --extra=+q .
...
silent only
cd /net/ecngzns004/vol/mg_git/git_store/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/provisioning
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2339 cmServiceProfileList.cc
badd +254 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/provisioning/cmServiceProfileList.h
badd +280 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmIpEndpoint.h
badd +4311 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmIpEndpoint.cc
badd +541 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/endpoint/cmEndpointBase.cc
badd +744 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/endpoint/cmEndpointBase.h
badd +199 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/audioMediaFsm/cmIpSdpFsmInactiveState.cc
badd +473 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/audioMediaFsm/cmIpSdpFsmUpInitIndicationWaitState.cc
badd +78 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/endpoint/cmEndpointData.h
badd +1657 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/includes/spmTypes.h
badd +174 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmEpDataIp.cc
badd +395 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmEpDataIp.h
badd +818 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/audioMediaFsm/cmIpSdpFsmSdpAvailableState.cc
badd +667 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmIpElements.cc
badd +77 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmIpElements.h
badd +229 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/base_types/spmTypes.cc
badd +1953 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/endpoint/cmEndpointData.cc
badd +86 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/provisioning/cmIpSubnetProfileConfig.cc
badd +266 /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/base/cmVsp4Defs.h
args cmServiceProfileList.cc
edit /git_store1/eqtuabe/MGW_GPM/vob/pvg-spm/code/mpc/application/connection_manager/ip/cmIpEndpoint.cc
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 4274 - ((0 * winheight(0) + 13) / 27)
